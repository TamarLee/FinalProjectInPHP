        ...
        <div class="row">
            ...
            <div class="wow fadeInUp col-md-4 col-sm-12" data-wow-delay="1s">
                <div class="overview-detail">
                    <h2>ჩვენს შესახებ</h2>
                    <p>Lians Fitness არის სატრენაჟორო დარბაზი, რომელიც გამოირჩევა უნიკალური დიზაინით, და მომხმარებელზე მაქსიმალურად ორიენტირებული პერსონალით.  ცენტრი მომხმარებლებს სთავაზობს ისეთ ვარჯიშებს როგორიცაა: <br> •   კარდიო ვარჯიშები, <br>•   მძიმე დატვირთვის ვარჯიშებს,<br>•   აერობიკას,<br>•   პილატესს,<br>•   ზუმბას,<br>•   სპინინგის ოთახი,<br>•   სინერჯი ტრეინინგი<br>•   და მრავალი სხვა.</p>
                    <a href="#trainer" class="btn btn-default smoothScroll">მეტი</a>
                </div>
            </div>
